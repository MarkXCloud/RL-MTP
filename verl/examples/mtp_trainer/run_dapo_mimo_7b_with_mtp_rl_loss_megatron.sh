...
project_name='DAPO'
exp_name='DAPO-mimo-7b-rl-megatron-mtp-rl-loss'
...
# Important: modify max_position_embeddings in config.json to 32768 after downloading from Hugging Face.
...
actor_rollout_ref.model.mtp.mtp_loss_type=rl
actor_rollout_ref.model.mtp.mtp_loss_scaling_factor=0.1
actor_rollout_ref.model.mtp.detach_encoder=False
)
